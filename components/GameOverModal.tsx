  ...
  return (
    <AnimatePresence>
      {isOpen && (
        ...
        >
          <motion.div
            className="bg-zinc-900 border border-zinc-700/80 rounded-2xl p-8 w-full max-w-sm text-center"
          ...
          >
            ...
            <button
              onClick={onRetry}
              className="w-full mb-3 py-3 rounded-xl bg-orange-500 hover:bg-orange-400 text-white font-medium transition-colors"
            >
              Try again
            </button>
              ...
              {(['easy', 'medium', 'hard', 'expert'] as Difficulty[])
                ...
                .map((d) => (
                  <button
                    ...
                    className="py-2 rounded-lg text-sm font-medium capitalize bg-zinc-800 text-zinc-400 hover:bg-zinc-700 hover:text-zinc-200 transition-colors"
                  >
                    {d}
                  </button>
                ))}
